...
import 'package:venatus_project/video_screen.dart';
import 'package:venatus_project/yt_key_api.dart';
...
class _DemoAppState extends State<DemoApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Psytrix CODM Tournament'),
            ...
            child: Container(
              ...
              ytResult[index].thumbnail['default']['url'], fit: BoxFit.cover, height: 206, width: double.infinity,
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(child: Text(ytResult[index].title, style: TextStyle(color: Color(0xFF373132), fontSize: 15),)),
